...
class SerialPortWriter(Node):
    def __init__(self):
        ...
        self.microcontroller_port = "/dev/ttyUSB1"
    ...
    def joint_states_callback(self, joint_states_msg):
        ...
        back_left_q1_in_degrees = int(math.degrees(joint_states_msg.position[3]))
        back_left_q2_in_degrees = int(math.degrees(joint_states_msg.position[4]))
        back_left_q3_in_degrees = int(math.degrees(joint_states_msg.position[5]))
        front_right_q1_in_degrees = int(math.degrees(joint_states_msg.position[6]))
        front_right_q2_in_degrees = int(math.degrees(joint_states_msg.position[7]))
        front_right_q3_in_degrees = int(math.degrees(joint_states_msg.position[8]))
        back_right_q1_in_degrees = int(math.degrees(joint_states_msg.position[9]))
        back_right_q2_in_degrees = int(math.degrees(joint_states_msg.position[10]))
        back_right_q3_in_degrees = int(math.degrees(joint_states_msg.position[11]))
        ...
        back_left_q1_in_bits = self.map_position_into_bits(front_left_q1_in_degrees, -150, 150, 0, 1023)
        ...
        front_right_q1_in_bits = self.map_position_into_bits(front_left_q2_in_degrees, -150, 150, 0, 1023)
        front_right_q2_in_bits = self.map_position_into_bits(front_right_q2_in_degrees, -150, 150, 0, 800)
        front_right_q3_in_bits = self.map_position_into_bits(front_right_q3_in_degrees, -150, 150, 0, 400)
        back_right_q1_in_bits = self.map_position_into_bits(front_left_q2_in_degrees, -150, 150, 0, 1023)
        back_right_q2_in_bits = self.map_position_into_bits(back_right_q2_in_degrees, -150, 150, 0, 800)
        back_right_q3_in_bits = self.map_position_into_bits(back_right_q3_in_degrees, -150, 150, 0, 400)
